  ...
  return (
    <span className="chk-anim" style={{ width: size, height: size, ...style }}>
      ...
      <svg viewBox="0 0 35 35">
        <circle className="chk-anim-bg" cx="17.5" cy="17.5" r="15.5" />
      ...
      <style>{`
        ...
        .chk-anim-bg { fill: #F57C00; transition: fill 0.4s ease; }
        .chk-anim-stroke {
        ...
        .chk-anim input[type=checkbox]:checked + svg .chk-anim-bg { fill: #E65100; }
